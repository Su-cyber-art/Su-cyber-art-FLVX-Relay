...
type TunnelMetric struct {
	ID           int64   `gorm:"primaryKey;autoIncrement" json:"id"`
	TunnelID     int64   `gorm:"column:tunnel_id;not null;index:idx_tunnel_metric_tunnel_time,priority:1;uniqueIndex:idx_tunnel_metric_bucket,priority:1" json:"tunnelId"`
	NodeID       int64   `gorm:"column:node_id;not null;index:idx_tunnel_metric_tunnel_time,priority:2;uniqueIndex:idx_tunnel_metric_bucket,priority:2" json:"nodeId"`
	Timestamp    int64   `gorm:"not null;index:idx_tunnel_metric_tunnel_time,priority:3;index:idx_tunnel_metric_time;uniqueIndex:idx_tunnel_metric_bucket,priority:3" json:"timestamp"`
