...
func buildWebSocketCandidates(addr string, secret string, version string, httpEnabled int, tlsEnabled int, socksEnabled int, preferredScheme string) []string {
	...
	query := "/system-info?type=1&secret=" + secret + "&version=" + version +
		"&http=" + strconv.Itoa(httpEnabled) + "&tls=" + strconv.Itoa(tlsEnabled) + "&socks=" + strconv.Itoa(socksEnabled)
