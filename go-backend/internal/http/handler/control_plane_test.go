...
func TestProcessServerAddress_StripsURLSchemeAndPath(t *testing.T) {
	tests := []struct {
		...
		{name: "https with path", in: "https://panel.example.com:8443/api/v1", want: "panel.example.com:8443"},
		{name: "wss with query", in: "wss://panel.example.com:443/system-info?x=1", want: "panel.example.com:443"},
		{name: "http without port", in: "http://panel.example.com", want: "panel.example.com"},
		{name: "manual host with trailing path", in: "panel.example.com:8080/path", want: "panel.example.com:8080"},
	}
...
func TestProcessServerAddress_NormalizesIPv6(t *testing.T) {
	tests := []struct {
		...
		{name: "ipv6 host and port", in: "https://[2001:db8::1]:8443/path", want: "[2001:db8::1]:8443"},
		{name: "already bracketed", in: "[2001:db8::2]:9000", want: "[2001:db8::2]:9000"},
	}
